...
console.log("Freaking Default Leads : ", data)
...
fetch('/get_data')
    ...
    .then(responseData => {
        ...
        let oppClosedUniqueDates = responseData.map((o, i) => o['Oppt Close Date']).filter(onlyUnique)
        ...
        /* leadNodes['nodes'] = [...getNodes(leadCreatedUniqueDates),
        ...getNodes(oppCreatedUniqueDates),
        ...getNodes(oppClosedUniqueDates)
        ]

        leadNodes['links'] = getLinks(responseData)
        console.log("Main Links : ", leadNodes) */

        // console.log("Default Leads : ", data)

        //////////////////////////////////////////////////////////


        var graph = leadNodes
        console.log("guppa : ", graph)
        ...
        (function (graph) {
            ...
            var link = svg.append("g").selectAll(".link")
                ...
                .attr("class", "link")
                .attr("d", path)
                .style("stroke-width", function (d) { if (d["source"]["name"] == "Aloha") console.log(d); return Math.max(1, d.dy); })
